...
wp-config.php must be writable by the server and code must be in the default format/spacing - 
...
3. Ensure wp-config.php iswritable by the server and the debug definition is in the default format/spacing - **define('WP_DEBUG', false);**
